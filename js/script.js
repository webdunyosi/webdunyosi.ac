...
const activeStudents = [
  ...
  },
  {
    ...
    avatar: "../images/students/MardayevSayfiddin.png", // o'quvchi rasmi
    attendance: 0, // yo'qlama foizi
    taskScore: 0, // vazifalar uchun ball
    projectScore: 0, // loyihalar uchun ball
    completedTasks: 0, // Coinlar soni
  ...
  {
    name: "Muhammadiyev Javohirbek", // o'quvchi ismi
...
function computeStudentsTotalScores() {
  activeStudents.forEach((student) => {
    ...
    const coin = Number(student.completedTasks) || 0
...
const newVideos = [
  ...
  // JAVASCRIPT NEW 2025
  {
    ...
    videos: [
      ...
      {
        id: 4,
        title: "4-dars. Taqqoslash operatorlari, If-else, Mantiqiy operatorlar",
        videoFile: "https://youtu.be/5xk_Izjxmrw",
        duration: "5:49", // minut,
        link: "https://heyzine.com/flip-book/ea5b71e571.html",
      },
      {
        id: 5,
        title: "5-dars. For Loop",
        videoFile: "https://youtu.be/6L0Sv5qi6SE",
        duration: "7:47", // minut,
        link: "https://heyzine.com/flip-book/83fca814d6.html",
      },
      {
        id: 6,
        title: "6-dars. Funksiya",
        videoFile: "https://youtu.be/jHHV0sYAW9U",
        duration: "5:08", // minut,
        link: "https://online.fliphtml5.com/faayf/xhkd/#p=1",
      },
      {
        id: 7,
        title: "7-dars. String methodlar",
        videoFile: "https://youtu.be/EkRuUG3qIwY",
        duration: "6:07", // minut,
        link: "https://online.fliphtml5.com/faayf/ytde/#p=1",
      },
      {
        id: 8,
        title: "8-dars. Number methodlar",
        videoFile: "https://youtu.be/BIgYlrabdH0",
        duration: "5:46", // minut,
        link: "https://www.flipbookpdf.net/web/site/471e820e26f0c1bd53b24efa1392ffb52c660fcc202511.pdf.html",
      },
      {
        id: 9,
        title: "9-dars. Callback, setTimeout(), setInterval(), clearInterval",
        videoFile: "https://youtu.be/8LrxWZo_SHI",
        duration: "5:13", // minut,
        link: "https://www.flipbookpdf.net/web/site/85220cf597ab21521b7f1f3b28c2d85b12c4bb1f202511.pdf.html",
      },
      {
        id: 10,
        title: "10-dars. Object, Method, Destruktizatsiya",
        videoFile: "https://youtu.be/Ag2kgH366fM",
        duration: "5:25", // minut,
      ...
      },
      {
        id: 22,
        title: "22-dars. Date",
        videoFile: "https://youtu.be/ftRfIvAROlk",
        duration: "7:16", // minut,
        link: "https://online.fliphtml5.com/faayf/rotv/#p=1",
      },
      {
        id: 23,
        title: "23-dars. Amaliyot. Loader va Date",
        videoFile: "https://youtu.be/fok76DNPs9c",
        duration: "5:00", // minut,
        link: "https://www.figma.com/design/j04szu1hpPF26iIOUqYPce/Bricks-app-design--Community-?node-id=0-1&p=f&t=Voqw92bLrYglO3Og-0",
      },
      {
        id: 24,
        title: "24-dars. Document va Window Parametrlari",
        videoFile: "https://youtu.be/u2vvOlzWSHk",
        duration: "12:32", // minut,
        link: "https://topscrolll.vercel.app/",
      },
      {
        id: 25,
        title: "25-dars. Amaliyot. Modal oyna",
        videoFile: "https://youtu.be/KcsmYz6mwA8",
        duration: "6:45", // minut,
        link: "https://online.fliphtml5.com/faayf/vscy/#p=1",
      },
      {
        id: 26,
        title: "26-dars. Promise, Fetch, Axios, Async await, Try catch",
        videoFile: "https://youtu.be/pz6eU9Qs4TQ",
        duration: "6:11", // minut,
        link: "https://online.fliphtml5.com/faayf/vdyy/#p=1",
      },
      {
        id: 27,
        title: "27-dars. Amaliyot. Axios Telegram BOT",
        videoFile: "https://youtu.be/SJkbtnebYnM",
        duration: "4:24", // minut,
        link: "https://online.fliphtml5.com/faayf/nwhj/#p=1",
      },
      {
        id: 28,
        title: "28-dars. JSON, NPM, package.json",
        videoFile: "https://youtu.be/vTxNQ58oZrY",
        duration: "9:27", // minut,
        link: "https://online.fliphtml5.com/faayf/fxyp/#p=1",
      },
      {
        id: 29,
        ...
        duration: "4:29", // minut,
        link: "https://online.fliphtml5.com/Alimardon/frem/#/p=1",
      },
      {
        id: 30,
        ...
        duration: "5:19", // minut,
        link: "https://online.fliphtml5.com/Alimardon/cpzf/#/p=1",
      },
      {
        id: 31,
        ...
        duration: "6:09", // minut,
        link: "https://online.fliphtml5.com/Alimardon/bvli/#/p=1",
      },
    ],
  },
  // REACTJS NEW 2025
...
const mnemonika = [
  ...
  // ANTI DANGASALIK
  {
    ...
    videos: [
      ...
      {
        id: 4,
        title: "4-dars. Anti dangasalik",
        videoFile: "https://youtu.be/TjkC0D9udc8",
        duration: "6:38",
      },
      {
        id: 5,
        title: "5-dars. Anti dangasalik",
        videoFile: "https://youtu.be/bpg5hnOZ9nE",
        duration: "1:27:14",
      },
      {
        id: 6,
        title: "6-dars. G'oyalar banki",
        videoFile: "https://youtu.be/Mb0B0x9gO0I",
        duration: "5:20",
      },
      {
        id: 7,
        title: "7-dars. Anti dangasalik. Jonli efir",
        videoFile: "https://youtu.be/iQ-3MFF-zeo",
        duration: "1:22:54",
      },
      {
        id: 8,
        title: "8-dars. Dom Nazariyasi",
        videoFile: "https://youtu.be/6hmMmG_T7ig",
        duration: "8:52",
      },
      {
        id: 9,
        title: "9-dars. Maqsad",
        videoFile: "https://youtu.be/iULY-g4enrI",
        duration: "6:04",
      },
      {
        id: 10,
        title: "10-dars. Anti dangasalik. Jonli efir",
        videoFile: "https://youtu.be/RRVO8cBd8k8",
        duration: "1:20:09",
      },
      {
        id: 11,
        title: "11-dars. Anti dangasalik",
        videoFile: "https://youtu.be/KUsBlw1mfZI",
        duration: "1:25:19",
      },
      {
        id: 12,
        title: "12-dars. Final",
        videoFile: "https://youtu.be/Xjur7vdD0A8",
        duration: "16:27",
      },
    ],
  },
...
const english = [
  // INGLIZ TILI
  {
    ...
    videos: [
      ...
      {
        id: 7,
        title: "6-dars. Non Action verbs (Stative verbs) Holat fe'llari",
        videoFile: "https://youtu.be/p34tI-mRMbk",
        duration: "17:32",
        link: "https://drive.google.com/file/d/1QlidszAWWSSZrZmBuId1iOcQ34naS8AV/view?usp=sharing",
      },
      {
        id: 8,
        title: `7-dars. Would like - qo'llanilishi "Think" fe'lini qachon ishlatsak bo'ladi?`,
        videoFile: "https://youtu.be/Nxh-ioZ17Uc",
        duration: "24:46",
        link: "https://drive.google.com/file/d/1sqU8S7BYWt6uWUTqtHbNZ2y70eKHQFLx/view?usp=sharing",
      },
      {
        id: 9,
        title: `8-dars. There is, There are va joy predloglari`,
        videoFile: "https://youtu.be/IWxuCSKr31w",
        duration: "22:05",
        link: "https://drive.google.com/file/d/1BJjC27iiXpNpnJhL_sEyJLX4JKX4tTsv/view?usp=sharing",
      },
      {
        id: 10,
        title: `9-dars. Nouns and pronouns. Otlar va olmoshlar`,
        videoFile: "https://youtu.be/PLU59XNZb9I",
        duration: "30:03",
        link: "https://drive.google.com/file/d/1bc8ylpCQYprpwPxnN18pFc_6txKWgx5F/view?usp=sharing",
      },
      {
        id: 11,
        title: `10-dars. Indefinite pronouns. Gumon olmoshlari`,
        videoFile: "https://youtu.be/NNqVB1HHzSg",
        duration: "11:55",
        link: "https://drive.google.com/file/d/1TkIBOC8MJF4eby5qbB0512XUrJH_07p-/view?usp=sharing",
      },
      {
        id: 12,
        title: `11-dars. The Simple Past Tense with "be". O'tgan zamonda "be" fe'li`,
        videoFile: "https://youtu.be/wIUB1kqmOx0",
        duration: "19:48",
        link: "https://drive.google.com/file/d/1zU8OhQ9JGxYDfkUY6jkRnASTY-BtuMjF/view?usp=sharing",
      },
      {
        id: 13,
        title: `12-dars. The Simple Past Tense. O'tgan zamon`,
        videoFile: "https://youtu.be/_UN6dKBmWG8",
        duration: "34:14",
        link: "https://drive.google.com/file/d/1ukKc-IYhEpkk2gAz0Uiz08qbpp1Pkm7j/view?usp=sharing",
      },
      {
        id: 14,
        title: `13-dars. Before, After, When`,
        videoFile: "https://youtu.be/YSzAexpt8C0",
        duration: "13:25",
        link: "https://drive.google.com/file/d/19B3Pk6c_b9sAbKS0VifSlGUJ2NBgByeR/view?usp=sharing",
      },
      {
        id: 15,
        title: `14-dars. Kelasi zamonni "will" va "going to" bilan ifodalash`,
        videoFile: "https://youtu.be/TxMYCvZ8xz0",
        duration: "23:06",
        link: "https://drive.google.com/file/d/1dN1Y53KzlxzIAZC67AUpCDHZSScvjt_C/view?usp=sharing",
      },
    ],
  },
]
  ...
  studentCard.innerHTML = `
    ...
    <div class="student-stats">
      ...
      <div class="stat-item">
        ...
        <div class="stat-label">Coinlar soni</div>
      </div>
    </div>

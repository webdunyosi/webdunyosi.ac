...
const activeStudents = [
  {
    ...
    attendance: 92, // yo'qlama foizi
    taskScore: 85, // vazifalar uchun ball
  ...
  },
  {
    ...
    taskScore: 93, // vazifalar uchun ball
  ...
  },
  {
    ...
    projectScore: 100, // loyihalar uchun ball
    completedTasks: 19, // bajarilgan vazifalar soni
  ...
  },
  {
    ...
    taskScore: 15, // vazifalar uchun ball
    projectScore: 100, // loyihalar uchun ball
  ...
  },
  {
    ...
    attendance: 94, // yo'qlama foizi
    taskScore: 86, // vazifalar uchun ball
    projectScore: 100, // loyihalar uchun ball
  ...
  },
  {
    ...
    attendance: 100, // yo'qlama foizi
    taskScore: 92, // vazifalar uchun ball
    projectScore: 100, // loyihalar uchun ball
    completedTasks: 13, // bajarilgan vazifalar soni
  ...
  },
  {
    ...
    taskScore: 57, // vazifalar uchun ball
    projectScore: 0, // loyihalar uchun ball
...
const oldVideos = [
  ...
  // CSS Dizayn
  {
    ...
    videos: [
      ...
      { id: 12, title: "12-dars  Practice", videoFile: "https://youtu.be/BEbj5gQD-zk" },
      { id: 13, title: "13-dars. CSSda hoshiya hosil qilish.", videoFile: "https://youtu.be/14-fHp3Htvw" },
      { id: 14, title: "14-dars.  Background property", videoFile: "https://youtu.be/SxNKh0jdlDc" },
      { id: 15, title: "15-dars. Amaliy mashg'ulot.", videoFile: "https://youtu.be/oKr-SaRucrw" },
      { id: 16, title: "16-dars.  Flexbox haqida.", videoFile: "https://youtu.be/BStVx2twbIo" },
      { id: 17, title: "17-dars. Amaliyot", videoFile: "https://youtu.be/PzZuMsegoL0" },
      { id: 18, title: "18-dars. Netlify app", videoFile: "https://youtu.be/tTPXYs0VqrY" },
      { id: 19, title: "19-dars.  filter propertysi haqida.", videoFile: "https://youtu.be/eWXv9Hdowbw" },
      { id: 20, title: "20-dars.  text-shadow, box-shadow, position va z-index", videoFile: "https://youtu.be/gGAUvnvyccU" },
      { id: 21, title: '21-dars.  Amaliyot. "Navbar", "Header"', videoFile: "https://youtu.be/kw3gHcc3tnE" },
      { id: 22, title: `22-dars.  Amaliyot.  "Process" bo'limi.`, videoFile: "https://youtu.be/HQEI1AuNA_Q" },
      { id: 23, title: `23-dars.  Amaliyot.  "Services" bo'limi.`, videoFile: "https://youtu.be/xX90Tihpsgw" },
      { id: 24, title: "24-dars. Amaliyot.  Achievement, About, Footer bo'limlari.", videoFile: "https://youtu.be/iD_zV4gPvzQ" },
      { id: 25, title: "25-dars. float, clear property.", videoFile: "https://youtu.be/ToW3-ugPgNo" },
      { id: 26, title: "CSS | 26. visibility propertysi haqida, Amaliy mashg'ulot.", videoFile: "https://youtu.be/bXuVBUyN43U" },
      { id: 27, title: "CSS | 27. Ikki holat o'rtasida animatsiya hosil qilish, transition propertylari.", videoFile: "https://youtu.be/DblcDGH3tBQ" },
      { id: 28, title: "28-dars. Animatsion tooltipli ijtimoiy tarmoq tugmachasini yasash.", videoFile: "https://youtu.be/2OYUciy6OvE" },
      { id: 29, title: "29-dars. linear-gradient, radial-gradient, repeating-linear-gradient, repeating-radial-gradient.", videoFile: "https://youtu.be/ygJw1ci7fIk" },
      { id: 30, title: "30-dars. background-clip, vendor prefixlar, prefix generatorlar.", videoFile: "https://youtu.be/B0aXMglwBoo" },
      { id: 31, title: "31-dars. Gradientni animatsiyalashga doir amaliyot.", videoFile: "https://youtu.be/5elTVHKpF2I" },
      { id: 32, title: "32-dars. var(), calc()", videoFile: "https://youtu.be/FktTAqhkrjw" },
      { id: 33, title: "33-dars. calc(), Column, object-fit va object-position propertylari.", videoFile: "https://youtu.be/7auAV8uKTJA" },
      { id: 34, title: "34-dars. 2D-transform, translateX, scaleY, scale, rotate, skewX, skewY, skew, transform-origin.", videoFile: "https://youtu.be/Tuy6x0izD_w" },
      { id: 35, title: "35-dars. Transform va transition`dan foydalanib, animatsion card yasaymiz.", videoFile: "https://youtu.be/RmnHFLC8oPk" },
      { id: 36, title: "36-dars. Bir necha holatlarni animatsiyalash. Animation xusisiyati va @keyframes direktivasi haqida.", videoFile: "https://youtu.be/g1fm0n5Wvl8" },
      { id: 37, title: "37-dars. HTML, CSS yordamida animatsion soat yasaymiz.", videoFile: "https://youtu.be/Hdl5dFAAZBs" },
      { id: 38, title: "38-dars. CSSda 3D-transformatsiya.", videoFile: "https://youtu.be/RAE8w-RgSz4" },
      { id: 39, title: "39-dars. 3D-transformatsiya yordamida kub yasaymiz.", videoFile: "https://youtu.be/NP0UJTxNs_E" },
      { id: 40, title: "40-dars. @media directive haqida.", videoFile: "https://youtu.be/Q_hi00grU-0" },
      { id: 41, title: "41-dars. viewport meta-tegi, @media directive`ga doir mashq.", videoFile: "https://youtu.be/t-9joNaC27Q" },
      { id: 42, title: "42-dars. Grid Layout strukturasi.", videoFile: "https://youtu.be/fB6MSCgkQOM" },
      { id: 43, title: "43-dars. Grid Layout yordamida responsive gallery yasaymiz.", videoFile: "https://youtu.be/XckfPomCSQw" },
    ],
  },
